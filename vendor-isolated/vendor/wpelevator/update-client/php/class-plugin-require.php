...
class Plugin_Require
{
    ...
    {
        $config_default = ['download_url' => self::UPDATE_PILOT_DOWNLOAD_URL, 'basename' => 'update-pilot/update-pilot.php', 'name' => 'Update Pilot', 'notice' => __('The Update Pilot plugin is required'), 'network' => true, 'license_key' => null, 'signing_key' => $this->get_default_signing_key()];
